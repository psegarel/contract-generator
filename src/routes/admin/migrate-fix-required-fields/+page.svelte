<script lang="ts">
	import { fixMissingRequiredFields } from '$lib/migration/fixMissingRequiredFields';
	...
	async function runMigration() {
		...
		try {
			const migrationResult = await fixMissingRequiredFields(isDryRun);
			result = {
...
<div class="p-8 max-w-4xl mx-auto">
	<h1 class="text-2xl font-bold mb-6">Fix Missing Required Fields</h1>
