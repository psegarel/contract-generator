<script lang="ts">
	import { cleanCounterpartyData } from '$lib/migration/cleanCounterpartyData';
	...
	async function runMigration() {
		...
		try {
			const migrationResult = await cleanCounterpartyData(isDryRun);
			result = {
...
<div class="p-8 max-w-4xl mx-auto">
	<h1 class="text-2xl font-bold mb-6">Clean Counterparty Data</h1>
	<p class="text-gray-600 mb-6">
		This migration validates each counterparty against its schema, removes invalid fields, and adds default values for missing required fields.
	</p>
