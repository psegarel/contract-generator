...
<div>
		<div class="flex justify-between items-center mb-8">
			<div>
				...
				<Button href={resolve('/v1/contacts')} class="flex items-center gap-2">
					<Plus class="h-4 w-4" />
			...
			{:else if clients.length === 0}
				<Card class="p-12 text-center">
					...
					<Button href={resolve('/v1/contacts')}>Add Contact</Button>
				</Card>
			{:else}
							...
							<div class="flex justify-between items-start mb-4">
								...
								<div class="flex gap-2">
									<Button
										variant="ghost"
										size="icon"
										href="{resolve('/v1/contacts')}?edit={client.id}"
