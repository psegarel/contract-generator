...
<div class="container mx-auto px-4 py-8 max-w-6xl">
	<div class="mb-6">
		<h1 class="text-3xl font-bold text-gray-900">Edit Equipment Rental (One-Off)</h1>
		<p class="text-gray-600 mt-2">
			Editing contract #{data.contract.contractNumber}
		</p>
	</div>

	<EquipmentRentalOneOffForm contract={data.contract} onSuccess={handleSuccess} onCancel={handleCancel} />
</div>
